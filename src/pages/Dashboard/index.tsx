      ...
      <Container>
        <CardContainer>
          <Card>
            ...
            <h1 data-testid="balance-income">{balance?balance.income:formatValue(0)}</h1>
          </Card>
          <Card>
            <header>
              <p>Saídas</p>
            ...
            <h1 data-testid="balance-outcome">{balance?balance.outcome:formatValue(0)}</h1>
          </Card>
          <Card total>
            <header>
              <p>Total</p>
            ...
            <h1 data-testid="balance-total">{balance?balance.total:formatValue(0)}</h1>
          </Card>
        </CardContainer>
